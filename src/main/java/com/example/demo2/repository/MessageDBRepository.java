...
public class MessageDBRepository implements Repository<Long, Message> {
    ...
    public MessageDBRepository(String url, String user, String password, Repository<Long, Utilizator> userRepo) {
        this.url = url;
        this.user = user;
        ...
        try (Connection connection = getConnection(url, user, password);
            ...
            try (ResultSet resultSet = preparedStatement.executeQuery()) {
                if (resultSet.next()) {
                    ...
                    Utilizator fromUser = userRepo.findOne(resultSet.getLong("from_user_id")).get();
                ...
                if (generatedKeys.next()) {
                    ...
                    if (!entity.getTo().isEmpty()) {
                        try (PreparedStatement insertRecipientStatement = connection.prepareStatement(insertRecipientSql)) {
                            for (Utilizator toUser : entity.getTo()) {
